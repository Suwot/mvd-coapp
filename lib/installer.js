...
const BROWSERS = {
  darwin: [
    {configDir: '~/Library/Application Support/Google/Chrome/', path: '~/Library/Application Support/Google/Chrome/NativeMessagingHosts', type: 'chrome', name: 'Google Chrome'},
    {configDir: '~/Library/Application Support/Google/Chrome Beta/', path: '~/Library/Application Support/Google/Chrome Beta/NativeMessagingHosts', type: 'chrome', name: 'Google Chrome Beta'},
    {configDir: '~/Library/Application Support/Google/Chrome Canary/', path: '~/Library/Application Support/Google/Chrome Canary/NativeMessagingHosts', type: 'chrome', name: 'Google Chrome Canary'},
    {configDir: '~/Library/Application Support/Google/Chrome Dev/', path: '~/Library/Application Support/Google/Chrome Dev/NativeMessagingHosts', type: 'chrome', name: 'Google Chrome Dev'},
    {configDir: '~/Library/Application Support/Chromium/', path: '~/Library/Application Support/Chromium/NativeMessagingHosts', type: 'chrome', name: 'Chromium'},
    {configDir: '~/Library/Application Support/Arc/User Data/', path: '~/Library/Application Support/Arc/User Data/NativeMessagingHosts', type: 'chrome', name: 'Arc'},
    {configDir: '~/Library/Application Support/Microsoft Edge/', path: '~/Library/Application Support/Microsoft Edge/NativeMessagingHosts', type: 'chrome', name: 'Microsoft Edge'},
    {configDir: '~/Library/Application Support/Microsoft Edge Beta/', path: '~/Library/Application Support/Microsoft Edge Beta/NativeMessagingHosts', type: 'chrome', name: 'Microsoft Edge Beta'},
    {configDir: '~/Library/Application Support/Microsoft Edge Dev/', path: '~/Library/Application Support/Microsoft Edge Dev/NativeMessagingHosts', type: 'chrome', name: 'Microsoft Edge Dev'},
    {configDir: '~/Library/Application Support/Microsoft Edge Canary/', path: '~/Library/Application Support/Microsoft Edge Canary/NativeMessagingHosts', type: 'chrome', name: 'Microsoft Edge Canary'},
    {configDir: '~/Library/Application Support/BraveSoftware/Brave-Browser/', path: '~/Library/Application Support/BraveSoftware/Brave-Browser/NativeMessagingHosts', type: 'chrome', name: 'Brave Browser'},
    {configDir: '~/Library/Application Support/BraveSoftware/Brave-Browser-Nightly/', path: '~/Library/Application Support/BraveSoftware/Brave-Browser-Nightly/NativeMessagingHosts', type: 'chrome', name: 'Brave Browser Nightly'},
    {configDir: '~/Library/Application Support/com.operasoftware.Opera/', path: '~/Library/Application Support/com.operasoftware.Opera/NativeMessagingHosts', type: 'chrome', name: 'Opera'},
    {configDir: '~/Library/Application Support/Vivaldi/', path: '~/Library/Application Support/Vivaldi/NativeMessagingHosts', type: 'chrome', name: 'Vivaldi'},
    {configDir: '~/Library/Application Support/Epic Privacy Browser/', path: '~/Library/Application Support/Epic Privacy Browser/NativeMessagingHosts', type: 'chrome', name: 'Epic Privacy Browser'},
    {configDir: '~/Library/Application Support/Yandex/YandexBrowser/', path: '~/Library/Application Support/Yandex/YandexBrowser/NativeMessagingHosts', type: 'chrome', name: 'Yandex Browser'},
    {configDir: '~/Library/Application Support/Mozilla/', path: '~/Library/Application Support/Mozilla/NativeMessagingHosts', type: 'firefox', name: 'Firefox'},
    {configDir: '~/Library/Application Support/TorBrowser-Data/Browser/', path: '~/Library/Application Support/TorBrowser-Data/Browser/NativeMessagingHosts', type: 'firefox', name: 'Tor Browser'}
  ],
  linux: [
...
async function detectBrowsers() {
  ...
  for (const browser of browsers) {
    ...
    if (platform === 'darwin' || platform === 'linux') {
      // Check for config directory existence (more reliable than app bundle)
